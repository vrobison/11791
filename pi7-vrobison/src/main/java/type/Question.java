 ...
 * Updated by JCasGen Mon Oct 19 14:45:36 EDT 2015
 * XML source: /home/vivian/git/11791/pi7-vrobison/src/main/resources/descriptors/typeSystem.xml
 * @generated */
public class Question extends ComponentAnnotation {
  ...
  */  
  ...
  /** getter for subject - gets The subject of the question as identified using dependency parsing
   * @generated
   * @return value of the feature 
   */
  public String getSubject() {
    if (Question_Type.featOkTst && ((Question_Type)jcasType).casFeat_subject == null)
      jcasType.jcas.throwFeatMissing("subject", "type.Question");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Question_Type)jcasType).casFeatCode_subject);}
    
  /** setter for subject - sets The subject of the question as identified using dependency parsing 
   * @generated
   * @param v value to set into the feature 
   */
