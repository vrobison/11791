 ...
 * Updated by JCasGen Mon Oct 19 14:44:01 EDT 2015
 * @generated */
public class Question_Type extends ComponentAnnotation_Type {
  ...
  /** @generated */
  final Feature casFeat_qpassages;
  /** @generated */
  final int     casFeatCode_qpassages;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public int getQpassages(int addr) {
        if (featOkTst && casFeat_qpassages == null)
      jcas.throwFeatMissing("qpassages", "type.Question");
    return ll_cas.ll_getRefValue(addr, casFeatCode_qpassages);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setQpassages(int addr, int v) {
        if (featOkTst && casFeat_qpassages == null)
      jcas.throwFeatMissing("qpassages", "type.Question");
    ll_cas.ll_setRefValue(addr, casFeatCode_qpassages, v);}
   ...
   */
  public int getQpassages(int addr, int i) {
        if (featOkTst && casFeat_qpassages == null)
      jcas.throwFeatMissing("qpassages", "type.Question");
    if (lowLevelTypeChecks)
      return ll_cas.ll_getRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_qpassages), i, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_qpassages), i);
  return ll_cas.ll_getRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_qpassages), i);
  }
   ...
   * @param v value to set
   */ 
  public void setQpassages(int addr, int i, int v) {
        if (featOkTst && casFeat_qpassages == null)
      jcas.throwFeatMissing("qpassages", "type.Question");
    if (lowLevelTypeChecks)
      ll_cas.ll_setRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_qpassages), i, v, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_qpassages), i);
    ll_cas.ll_setRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_qpassages), i, v);
  }
  ...
  public String getSubject(int addr) {
      ...
      jcas.throwFeatMissing("subject", "type.Question");
  ...
  public Question_Type(JCas jcas, Type casType) {
    ...
    casFeat_qpassages = jcas.getRequiredFeatureDE(casType, "qpassages", "uima.cas.FSArray", featOkTst);
    casFeatCode_qpassages  = (null == casFeat_qpassages) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_qpassages).getCode();
